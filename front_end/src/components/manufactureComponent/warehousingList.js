...
class warehousingList extends Component {
    constructor(props) {
        super(props);
        this.state = {
            datas: [],
    ...
    render() {
        ...
        return (
            <div style={{padding: '30px'}}>
                <div>
                    <Typography variant="h4" style={style}> 생산 입고 조회</Typography>
                </div>
                <br/>
                    ...
                    <Table style={tableStyle}>
                        <TableHead style={{backgroundColor: 'lightgray'}}>
                            <TableRow>
                                ...
                                <TableCell style={tableCellTitleStyle} onClick={() => this.sortUsingMaterialReciveId()}> 입고코드▽ </TableCell>
                        ...
                        <TableBody>
                            {this.state.displayedDatas.map((data, index) => (
                                <TableRow>
                                    ...
                                    <TableCell style={tableCellTitleStyle}> {data.materialReciveId} </TableCell>
