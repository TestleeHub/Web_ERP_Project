                ...
                <div>
                    ...
                    <   TableHead style={{ backgroundColor: 'lightgray' }}>
                            <TableRow>
                                ...
                                <TableCell style={tableCellTitleStyle} onClick={() => this.sortUsingSalesFormId()} align="center">주문 번호▽</TableCell>
                        ...
                        <TableBody>
                            {this.state.displayedDatas.map((data, index) => (
                                <TableRow>
                                    ...
                                    <TableCell style={tableCellTitleStyle}>{data.salesFormId}</TableCell>
                                    ...
                                    <TableCell style={tableCellTitleStyle}>{this.formatDate(data.dueDate) ? this.formatDate(data.dueDate) : 'N/A'}</TableCell>
                    ...
                    <Button variant="contained" style={normalButton} onClick={() =>  this.props.history.push('/purchase/salesForm_Form')}>신규</Button>
                </div>
            </div>
        );
    }
