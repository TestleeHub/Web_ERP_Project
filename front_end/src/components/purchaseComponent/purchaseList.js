                ...
                <div>
                    ...
                    <TableHead style={{ backgroundColor: 'lightgray' }}>
                            <TableRow>
                                ...
                                <TableCell style={tableCellTitleStyle} onClick={() => this.sortUsingPurchaseId()} align="center">구매 번호▽</TableCell>
                                <TableCell style={tableCellTitleStyle} onClick={() => this.sortUsingCustomerName()} align="center">거래처명▽</TableCell>
                                <TableCell style={tableCellTitleStyle} onClick={() => this.sortUsingMaterialName()} align="center">원재료명▽</TableCell>
                        ...
                        <TableBody>
                            {this.state.displayedDatas.map((data, index) => (
                                <TableRow>
                                    ...
                                    <TableCell style={tableCellTitleStyle}>{data.purchaseId}</TableCell>
                                    <TableCell style={tableCellTitleStyle}>{data.customer ? data.customer.name : 'N/A'}</TableCell>
                                    <TableCell style={tableCellTitleStyle}>{data.details[0].material ? data.details[0].material.name : 'N/A'}</TableCell>
                    ...
                    <Button variant="contained" style={normalButton} onClick={() =>  this.props.history.push('/purchase/purchaseForm')}>신규</Button>
                </div>
            </div>
        );
    }
